...
class StatusPinjamMhs extends CI_Controller {
	...
	public function statusPinjam(){
        ...
        //get the posts data
        $data['posts'] = $this->statuspinjammodel->getRowsTest(array('limit'=>$this->perPage));
    ...
    function ajaxStatusPinjam(){
        ...
        $data['offset'] = $offset;
        //load the view
        $this->load->view('status_pinjam/ajax-status-pinjam-data-test', $data, false);
    }

    function test(){
    	$this->load->view('status_pinjam/status_progress');
    }
}